...
// const tabs = [
//   { label: "Home", icon: "home-outline", activeIcon: "home", route: "WorkerHome" },
//   { label: "History", icon: "time-outline", activeIcon: "time", route: "JobHistory" },
//   { label: "Alerts", icon: "notifications-outline", activeIcon: "notifications", route: "Notifications" },
...
//   /* keeps spacing above system nav (android) */
//   safeArea: {
